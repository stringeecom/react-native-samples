...
export default class HomeScreen extends Component {
  ...
  sendMessageDemo = () => {
    ...
    updateConversation = () => {
      ...
      client.getConversationById('conv-vn-1-NPN1PHYU8X-1550877232011', (status, code, message, conversation) => {
      ...
      // const params = {
      //   name: "Doi Ten Lan Nua",
      //   avatar: ""
      // };

      // this.refs.client.updateConversation(this.state.convId, params, (status, code, message) => {
      //   console.log(
      //     "status-" +
      //       status +
      //       " code-" +
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>Đang đăng nhập: {this.state.myUserId}</Text>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={this.updateConversation}
          >
