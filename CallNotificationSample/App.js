...
const user1 = 'YOUR_USER1_TOKEN';
const user2 = 'YOUR_USER2_TOKEN';
...
class App extends Component {
    ...
    constructor(props) {
        ...
        VoipPushNotification.addEventListener('notification', notification => {
            ...
            console.log('Notification CallSerial: ' + callSerial + ' callId: ' + callId + 'uuid: ' + callKitUUID);
            // Neu call da duoc xu ly roi thi end callkit vua show
            if (this.handledCall(callId, callSerial)) {
                console.log("========== CUOC GOI DA DUOC XU LY ======= ==> END CALL: " + callId + ", serial: " + callSerial);
            ...
            if (this.state.syncCall == null) {
                ...
                console.log("========== TAO CALL MOI =======: " + callId + ", serial: " + callSerial);
                var newSyncCall = new SyncCall();
                newSyncCall.callId = callId;
    ...
    _callIncomingCall = ({
        ...
        if (this.handledCall(callId, serial)) {
            console.log("========== CUOC GOI DA DUOC XU LY ======= ==> Reject: " + callId + ", serial: " + serial);
    ...
    _callDidChangeSignalingState = ({
        ...
        console.log(
            ...
            sipCode +
            ' sipReason-' +
            sipReason + 'serial: ' + serial
        )

        if (this.state.syncCall != null) {
            if (this.state.syncCall.serial != serial) {
                return;
            }
